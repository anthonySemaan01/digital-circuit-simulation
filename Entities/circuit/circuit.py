        ...
        with open(file_path, 'r') as file:
            for line in file:
                ...
                if line.startswith("INPUT"):
                    ...
                    new_output_wire = Wire(name=line.split('(')[1].split(')')[0])
                    ...
                    created_gate = Gate(name=gate_name, gate_type=gate_type, fanin_wires=[])
                                ...
                                if len(wire.fanout) == 0:
                                    wire_one = Wire(name=f"{fanin_wire_name}.{len(wire.fanout) + 1}",
                                                    ...
                                                    direct_connect_to_gate=self.get_gate_by_name(
                                                        wire.direct_connect_to_gate.name),
